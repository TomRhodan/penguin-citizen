...
// Sizes are best-guess until the actual v0.5.12 artifacts are uploaded; the
...
export const FALLBACK = {
  ...
  assets: {
    deb: {
      url: 'https://github.com/TomRhodan/penguin-citizen/releases/download/v0.5.12-1/Penguin.Citizen_0.5.12_amd64.deb',
      size: 9_536_646,
    },
    appimage: {
      url: 'https://github.com/TomRhodan/penguin-citizen/releases/download/v0.5.12-1/Penguin.Citizen_0.5.12_amd64.AppImage',
      size: 81_762_808,
    },
    portable: {
      url: 'https://github.com/TomRhodan/penguin-citizen/releases/download/v0.5.12-1/penguin-citizen_0.5.12_amd64_portable.tar.gz',
      size: 97_204_144,
    },
  },
};
